...
export const ACTION_TYPES = {
  ...
  FETCH_PROJECT_TASK_LIST: 'task/FETCH_PROJECT_TASK_LIST',
...
export default (state: TaskState = initialState, action): TaskState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.FETCH_PROJECT_TASK_LIST):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.FETCH_PROJECT_TASK_LIST):
    ...
    case SUCCESS(ACTION_TYPES.FETCH_PROJECT_TASK_LIST):
      return {
        ...state,
        loading: false,
        entity: action.payload.data
...
export const getEntitiesByProject: IGetByProjectAction<ITask> = projectId => {
